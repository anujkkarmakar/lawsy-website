 ...
 */ declare class __PRIVATE_AsyncQueueImpl {
     ...
     */ hu(e: any): Promise<void>;
    /**
     * For Tests: Skip all subsequent delays for a timer id.
     */ Pu(e: any): void;
    /** Called once a DelayedOperation is run or canceled. */ uu(e: any): void;
}
 ...
 */ declare class __PRIVATE_UserDataReader {
    ...
    serializer: any;
    /** Creates a new top-level parse context. */ yu(e: any, t: any, n: any, r?: boolean): __PRIVATE_ParseContextImpl;
}
...
declare class __PRIVATE_DatastoreImpl extends __PRIVATE_DatastoreImpl_base {
    ...
    A_: boolean;
    R_(): void;
    /** Invokes the provided RPC with auth and AppCheck tokens. */ So(e: any, t: any, n: any): Promise<any>;
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ vo(e: any, t: any, n: any, r: any): Promise<any>;
    terminate(): void;
}
/**
 * @license
 ...
 */ declare class __PRIVATE_SyncEngineImpl {
     ...
     */
    wa: Map<any, any>;
    Sa: __PRIVATE_ReferenceSet;
    /** Stores user completion handlers, indexed by User and BatchId. */
    ba: {};
    /** Stores user callbacks waiting for all pending writes to be acknowledged. */
    Da: Map<any, any>;
    Ca: __PRIVATE_TargetIdGenerator;
    onlineState: string;
